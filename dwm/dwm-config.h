...
static const char bg1[]       = "#222222";
static const char border1[]       = "#444444";
static const char fg1[]       = "#bbbbbb";
static const char fg2[]       = "#eeeeee";
static const char select_col[]        = "#ffaa00";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { fg1,       bg1,       border1 },
	[SchemeSel]  = { fg2, select_col,      select_col},
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", bg1, "-nf", fg1, "-sb", select_col, "-sf", fg2, NULL };
static const char *termcmd[]  = { "urxvt", NULL };
#include "custom/volume_control.h"
